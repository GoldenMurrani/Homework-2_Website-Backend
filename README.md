# [Web Application Development](https://gitlab.msu.edu/cse477-spring-2023/course-materials/): Homework 2
...
```bash
gcloud builds submit --tag gcr.io/cse477-spring-2023/homework2
gcloud run deploy --image gcr.io/cse477-spring-2023/homework2 --platform managed
```
...
[Submit the Service URL for your live web application in this Google Form](https://docs.google.com/forms/d/e/1FAIpQLSfCF7m5HT8ye_oT7k49I389x-hOF20fEN1bfrRtKnbl-9cR3g/viewform). 
